...
class FvCommunityNews_Form_Validator_Alnum extends FvCommunityNews_Form_Validator {
	
	/**
	 *	Error Message
	 *	@var string
	 */
	protected $_message = 'This field may only contain alphabetic or digit characters.';
