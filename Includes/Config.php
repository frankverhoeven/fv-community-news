...
final class FvCommunityNews_Config {
	...
	/**
	 *	Tags database table structure
	 *	@var string
	 */
	private static $_tagsDbTable = "";
	
	/**
	 *	Tag relationships database table structure
	 *	@var string
	 */
	private static $_tagRelationshipsDbTable = "";
	 ...
	 *		@return string
	 */
	public static function getTagsDbTable($tableName) {
		return str_replace('%TableName%', $tableName . '_tags', self::$_dbTable);
	}
	
	/**
	 *		getTagRelationshipsDbTable()
	 *
	 *		@param string $tableName
	 *		@return string
	 */
	public static function getTagRelationshipsDbTable($tableName) {
		return str_replace('%TableName%', $tableName . '_tag_relationships', self::$_dbTable);
	}
