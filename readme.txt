...
* Captcha Spam protection (optional)
...
A: This Wordpress plugin requires WP 3.0 and has been tested up to version 3.0
...
A: The easiest way to do this is to use the build-in tags. You can put <!--fvCommunityNews:Submissions-->, <!--fvCommunityNews:Form--> or <!--fvCommunityNews:Archive--> in your page to display a list of recent submissions, the form to add news or a complete archive.
