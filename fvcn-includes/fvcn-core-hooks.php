 ...
 * fvcn_widgets_init
 */
add_action('fvcn_widgets_init', [ListPostsWidget::class, 'register_widget'], 10);
add_action('fvcn_widgets_init', [FormWidget::class, 'register_widget'], 10);
add_action('fvcn_widgets_init', [TagCloudWidget::class, 'register_widget'], 10);
