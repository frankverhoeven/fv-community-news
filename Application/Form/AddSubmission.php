		...
		if ($this->isValid()) {
			...
			$dbTable->add(
				new fvCommunityNewsModel_Submission(array(
					'Name'			=> apply_filter('fvcn_PreName', $this->getElement('fvcn_User')->getValue()),
					'Email'			=> apply_filter('fvcn_PreEmail', $this->getElement('fvcn_Email')->getValue()),
					'Title'			=> apply_filter('fvcn_PreTitle', $this->getElement('fvcn_Title')->getValue()),
					'Location'		=> apply_filter('fvcn_PreLocation', ('http://'==$this->getElement('fvcn_Location')->getValue()?'':$this->getElement('fvcn_Location')->getValue())),
					'Description'	=> apply_filter('fvcn_PreDescription', $this->getElement('fvcn_Description')->getValue()),
