		...
		<form name="fvcn-settings" action="admin.php?page=fvcn-admin-settings" method="post">
			...
			<div id="fvcn-general" class="fvcn-tab-content current">
				...
				<table class="form-table">
					...
					<tr valign="top">
						<th scope="row"><?php _e('Tracking', 'fvcn'); ?></th>
						<td><fieldset>
								<legend class="hidden"><?php _e('My Submissions', 'fvcn'); ?></legend>
								<label for="fvcn_Tracking">
									<input type="checkbox" name="fvcn_Tracking" id="fvcn_Tracking" value="1"<?php checked($settings->get('Tracking'), true); ?> />
									<span class="description"><?php _e('Keep stats of how many times a link is clicked. (Experimental)', 'fvcn'); ?></span></label>
							</fieldset></td>
					</tr>
				</table>
			</div>
