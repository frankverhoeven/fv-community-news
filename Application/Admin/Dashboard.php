...
class fvCommunityNewsAdmin_Dashboard extends fvCommunityNewsAdmin_Abstract {
	...
	public function hook() {
		if (current_user_can('manage_options')) {
			wp_add_dashboard_widget('fvcn-admin-widget', __('Recent Community News', 'fvcn'), array($this, 'render'), array($this, 'settings'));
		}
	}
	...
	public function render() {
		...
		$this->_view->tracking = $this->_settings->get('Tracking');
