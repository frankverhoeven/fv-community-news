...
class fvCommunityNewsWpHead {
	...
	public function render() {
		...
		wp_enqueue_script('fvcn-form-add', WP_PLUGIN_URL . FVCN_PLUGINDIR . '/public/javascript/form/add-submission.js', 'jquery');
		if ($this->_settings->get('Tracking')) {
			wp_enqueue_script('fvcn-tracker', WP_PLUGIN_URL . FVCN_PLUGINDIR . '/public/javascript/tracker.js', 'jquery');
		}
